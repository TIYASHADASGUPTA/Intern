...
<head>
    ...
    define('bankName', 'SparksBank',true);
...
<h1 class="alert alert-success rounded-0"><?php echo "SPARKS"; ?><small class="float-right text-muted" style="font-size: 12pt;"></small></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 222px">
  ...
  <div class="card rounded-0">
    ...
    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       <form method="POST">
       	<input type="email" value="someone@gmail.com" name="email" class="form-control" required placeholder="Enter Email">
